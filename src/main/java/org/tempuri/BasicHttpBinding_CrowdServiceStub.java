...
public class BasicHttpBinding_CrowdServiceStub extends org.apache.axis.client.Stub implements sutd.edu.sg.CrowdService {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("sg.edu.sutd", "workers"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/Arrays", "ArrayOfKeyValueOfstringArrayOfCrowdWorker8Qgdyvm9"), CSWorker[].class, false, false);
        ...
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("sg.edu.sutd", "resultNums"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/Arrays", "ArrayOfKeyValueOfstringint"), CSResultNum[].class, false, false);
 ...
 try {        Object _resp = _call.invoke(new Object[] {value});
  ...
  throw axisFaultException;
    ...
    public sutd.edu.sg.CrowdOptimizationResult globalOptimize(String xml, Long globalTimeConstraint, Double globalCostConstraint, CSWorker[] workers, CSResultNum[] resultNums, Integer numOfGeneration) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
